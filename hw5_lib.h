...
int compareNumbs(int a,int b,int c,int d, int e);
double determine_angle(double* x, double* y);
int binary(unsigned char n);
int chartoInt(char c);

void operate_polynomials  (double* a3, double* a2, double* a1, double* a0, double* b3, double* b2, double* b1, double* b0, char op);q
